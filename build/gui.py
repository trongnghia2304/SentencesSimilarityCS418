...
# Create the scrollable canvas and the scrollbar
scrollable_canvas = Canvas(window, bg="#FFFFFF", bd=0, highlightthickness=0)
scrollable_canvas.place(x=600.0, y=80.0, width=430.0, height=520.0)

# Scrollbar
scroll_y1 = Scrollbar(window, orient="vertical", command=scrollable_canvas.yview)
scroll_y1.place(x=1030.0, y=80.0, height=520)
scrollable_canvas.configure(yscrollcommand=scroll_y1.set)

# Frame inside the canvas
frame = Frame(scrollable_canvas, bg="#FFFFFF")
scrollable_canvas.create_window((0, 0), window=frame, anchor='nw')

# Button for browsing folders
button_1 = Button(window, text="Choose folder", command=browse_button)
button_1.place(x=246.0, y=41.0, width=297.0, height=66.0)

# Entry for typing in the similarity level
entry_1 = Entry(window, textvariable=similarity_level, bd=0, bg="#FFFFFF", fg="#000716", highlightthickness=0)
entry_1.place(x=400.0, y=520.0, width=143.0, height=44.0)
